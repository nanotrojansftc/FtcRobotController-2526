...
@Autonomous
public class AutonomousDecodeSPTwoStartingShootIdealRed extends LinearOpMode{
    ...
    private double lgunpower = -1;
    private double rgunpower = 1;
...
//    public final Pose aprilTagScanning = new Pose(72.000, 96.000, Math.toRadians(90));
    private final Pose shootPose = new Pose(86, 26, Math.toRadians(65));
