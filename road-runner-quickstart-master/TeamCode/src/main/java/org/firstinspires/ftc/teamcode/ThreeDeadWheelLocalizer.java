...
public final class ThreeDeadWheelLocalizer implements Localizer {
    ...
    public static class Params {
        public double par0YTicks = 1168.8606833493511; // 0.0; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1542.3052053709841; //1.0; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1687.3512687304515; //0.0; // x position of the perpendicular encoder (in tick units)
    }
}
