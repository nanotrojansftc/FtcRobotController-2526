...
@Autonomous(name = "4th-Far Red Modular Auto", group = "4thMeet")
public class FarRedModularAutonomous extends LinearOpMode {
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            Path2 = follower.pathBuilder()
                    .addPath(new BezierLine(new Pose(83.9, 18.9), new Pose(109, 18)))
